...
> **Estado:** Parcial — sucedido y cerrado por [`shared-noise-coverage-knobs.md`](./shared-noise-coverage-knobs.md) (shipped **2.4.3**).  
> **Sucesor (archivado):** [`shared-noise-coverage-knobs.md`](./shared-noise-coverage-knobs.md) · [`PROMPT-shared-noise-coverage-knobs.md`](./PROMPT-shared-noise-coverage-knobs.md).  
> No editar salvo corrección histórica.

**Status:** Archived (partial → closed by 2.4.3 successor)  
**Date:** 2026-08-26  
...
**Version on ship:** superseded — see [`shared-noise-coverage-knobs.md`](./shared-noise-coverage-knobs.md) (**2.4.3**).
