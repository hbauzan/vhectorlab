...
export const FIELD_INFO = Object.freeze({
  ...
  sameSignCancel: 'Hide near-median tokens.',
  sameSignCoverage: 'Near median, then outliers.',
  ...
  spectralQuorum: 'ddi-fw 10% Quorum.',
  spectralColor: 'Quorum glow color.',
  spectralQuorumPercent: 'Top % discriminant dims.',
  spectralHighlight: 'Highlight intensity.',
  spectralBaselineCancel: 'Fade structural baseline noise.',
  spectralPajaCancel: 'Fade structural baseline noise.',
  spectralDecimalGain: 'Decimal Δ multiplier.',
